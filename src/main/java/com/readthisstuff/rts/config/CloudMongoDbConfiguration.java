...
import com.readthisstuff.rts.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.readthisstuff.rts.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.readthisstuff.rts.config.dbmigrations");
