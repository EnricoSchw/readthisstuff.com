package com.readthisstuff.webapp.config;
...
@Configuration
@EnableMongoRepositories("com.readthisstuff.webapp.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.readthisstuff.webapp.config.dbmigrations");
